...
public class MainMenuUIMediator : Mediator, IMediator
{
    ...
    public override void HandleNotification(INotification notification)
    {
        ...
        MainMenuView uiView = ViewComponent as MainMenuView;
        switch (notification.Name)
        {
            case MainMenuUIMediator.REFRESH_USER_INFO_VALUE:
                {
					uiView.PlayerName = (notification.Body as UserInfoVO).PlayerName;
                    uiView.Level = (notification.Body as UserInfoVO).Level;
