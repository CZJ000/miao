...
public class CustomerView : MonoBehaviour {
    ...
    public void RemoveCustomer()
    {
        if (currentCustomer > 0)
        {
            ...
            MainMenuView mainMenuUIView = (MainMenuView)mainMenuUIMediator.ViewComponent;
    ...
    {
        Debug.LogWarning("LOg warning" + customerVO.Id);
    ...
    {
        AppFacade.getInstance.SendNotification(NotiConst.ADD_CUSTOMER_MODEL);
    }
