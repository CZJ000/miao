...
public class AppFacade : Facade, IFacade
{
    ...
    protected override void InitializeController()
    {
        ...
        RegisterCommand(NotiConst.INIT_ASSISTANT_VIEW, typeof(InitAssistantCommand)); // 注册店长
        RegisterCommand(NotiConst.INIT_CLERK_VIEW, typeof(InitClerkCommand)); // 注册店员
        //Login & Register
        ...
        //NeighborInfo
        RegisterCommand(NotiConst.GET_NEIGHBOR_INFO_VALUE, typeof(RefreshNeighborInfoValueCommand));
        ...
        RegisterCommand(NotiConst.CAT_CHANGE_GROUP, typeof(ShowCatGroupCommand));
        ...
        //Assistant
        RegisterCommand(NotiConst.SET_ASSISTANT, typeof(SetAssistantCommand));

        //Clerk
        RegisterCommand(NotiConst.SET_CLERK, typeof(SetClerkCommand));
        RegisterCommand(NotiConst.LEVEL_UP_CLERK, typeof(LevelUpClerk));
        ...
        RegisterCommand(NotiConst.SALE_BLUEPRINT, typeof(ShowBuildingBlueprintCommand));

        //Battle 
        RegisterCommand(NotiConst.GET_BATTLE_CAT_GROUP_INFO,typeof(ShowBattleCatGropCommand));
        RegisterCommand(NotiConst.GET_BATTLE_RANDOM_CAT_INFO, typeof(ShowBattleCatGropCommand));
        RegisterCommand(NotiConst.SET_BATTLE_RESULT_EXP, typeof(SetBattleResultCommand));
    ...
    public void QuitGameAndSave()
    {
        ...
        (RetrieveProxy(CatGroupProxy.NAME) as CatGroupProxy).SaveToDb();
    }
}