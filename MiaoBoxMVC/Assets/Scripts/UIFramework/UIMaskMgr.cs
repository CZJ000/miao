...
namespace SUIFW
{
    public class UIMaskMgr : MonoBehaviour
    {
        ...
        {
            //得到UI根节点对象、脚本节点对象
            _GoCanvasRoot = GameObject.FindGameObjectWithTag(NotiConst.SYS_TAG_CANVAS);
            _TraUIScriptsNode = Utils.FindTheChildNode(_GoCanvasRoot, NotiConst.SYS_SCRIPTMANAGER_NODE);
            //把本脚本实例，作为“脚本节点对象”的子节点。
            Utils.AddChildNodeToParentNode(_TraUIScriptsNode, this.gameObject.transform);
            //得到“顶层面板”、“遮罩面板”
            _GoTopPanel = _GoCanvasRoot;
            _GoMaskPanel = Utils.FindTheChildNode(_GoCanvasRoot, "_UIMaskPanel").gameObject;
            //得到UI摄像机原始的“层深”
	    ...
	    public void SetMaskWindow(GameObject goDisplayUIForms, UIFormLucenyType lucenyType = UIFormLucenyType.Lucency)
        {
            ...
            switch (lucenyType)
            {
                ...
                case UIFormLucenyType.Lucency:
                    ...
                    Color newColor1 = new Color(NotiConst.SYS_UIMASK_LUCENCY_COLOR_RGB, NotiConst.SYS_UIMASK_LUCENCY_COLOR_RGB, NotiConst.SYS_UIMASK_LUCENCY_COLOR_RGB, NotiConst.SYS_UIMASK_LUCENCY_COLOR_RGB_A);
                    _GoMaskPanel.GetComponent<Image>().color = newColor1;
                    break;
                //半透明，不能穿透
                case UIFormLucenyType.Translucence:
                    _GoMaskPanel.SetActive(true);
                    Color newColor2 = new Color(NotiConst.SYS_UIMASK_TRANS_LUCENCY_COLOR_RGB, NotiConst.SYS_UIMASK_TRANS_LUCENCY_COLOR_RGB, NotiConst.SYS_UIMASK_TRANS_LUCENCY_COLOR_RGB, NotiConst.SYS_UIMASK_TRANS_LUCENCY_COLOR_RGB_A);
                    _GoMaskPanel.GetComponent<Image>().color = newColor2;
                    break;
                //低透明，不能穿透
                case UIFormLucenyType.ImPenetrable:
                    _GoMaskPanel.SetActive(true);
                    Color newColor3 = new Color(NotiConst.SYS_UIMASK_IMPENETRABLE_COLOR_RGB, NotiConst.SYS_UIMASK_IMPENETRABLE_COLOR_RGB, NotiConst.SYS_UIMASK_IMPENETRABLE_COLOR_RGB, NotiConst.SYS_UIMASK_IMPENETRABLE_COLOR_RGB_A);
