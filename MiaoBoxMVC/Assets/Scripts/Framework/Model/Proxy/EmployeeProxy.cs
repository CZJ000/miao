...
public class EmployeeProxy : Proxy, IProxy
{
    ...
    private  FailType failtype =  FailType.Money;
    ...
    public void AddEmployeeModel(int cattypeid)
    {
        ...
        Temp_EmployeeInfoData = new EmployeeInfoVO(
                                                       ...
                                                       manorInfoProxy.catDic[cattypeid].Power, 
        ...
        Facade.SendNotification(SpawnRandomCatMediator.GENERATE_EMPLOYEE, Temp_EmployeeInfoData);
    }
