...
public class UserInfoProxy : Proxy, IProxy
{
    ...
    public void setExpNotRefrsh(int value)
    {
        Data.Exp = value;
    ...
    /// <summary>
    /// 设置新的模型建筑与位置信息（取代原来的建筑）
    /// </summary>
    /// <param name="vo"></param>
    public void Exchangefacility(BuildModelVo vo)
    {
